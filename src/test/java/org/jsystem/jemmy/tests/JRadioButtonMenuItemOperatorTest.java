/*
 * $Id: JRadioButtonMenuItemOperatorTest.java,v 1.2 2006/06/30 14:00:52 jtulach Exp $
 *
 * ---------------------------------------------------------------------------
 *
...
public class JRadioButtonMenuItemOperatorTest extends TestCase {
    ...
    public void testConstructor() {
        ...
        JRadioButtonMenuItemOperator operator3 = new JRadioButtonMenuItemOperator(popup, new NameComponentChooser("Radio Button 1"));
        assertNotNull(operator3);

        JRadioButtonMenuItemOperator operator4 = new JRadioButtonMenuItemOperator(popup, "Radio Button 1");
